...
Begin VB.Form frmTemp 
   ...
   Begin VB.Frame fraColors 
      ...
      Top             =   1470
      Width           =   4935
      Begin PrintPicture.AASelectColor AASelectColor1 
         Height          =   315
         Left            =   1110
         TabIndex        =   8
         TabStop         =   0   'False
         ...
         _ExtentY        =   556
      End
      Begin PrintPicture.AASelectColor AASelectColor2 
         Height          =   315
         Left            =   3870
         TabIndex        =   9
         TabStop         =   0   'False
   ...
   Begin VB.CheckBox chkPreview 
      ...
      Width           =   885
   End
   Begin PrintPicture.AAPrintPicture AAPrintPicture1 
      Left            =   6060
      Top             =   60
      _ExtentX        =   688
      _ExtentY        =   661
      Picture         =   "frmTemp.frx":0532
      Printer         =   "HP LaserJet 1200 (PC6)"
   End
